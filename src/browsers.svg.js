...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/badges$7.5.1/src/browsers.svg",
...
function render(input, out, __component, component, state) {
  ...
  marko_forOf(data.layout.badges, function(badge, badgeIdx, badges) {
    ...
    marko_forOf(badge.versions, function(browser, browserIdx, browsers) {
      var $keyScope$2 = "[" + ((($for$2++) + $keyScope$1) + "]");

      out.w("<g" +
        marko_attr("transform", ("translate(" + browser.translate) + ", 0)") +
        "><rect" +
        marko_attr("width", "" + browser.width) +
        " height=\"20\"" +
        marko_attr("fill", "" + browser.fill) +
        marko_attr("shape-rendering", data.layout.style === "flat-square" ? "crispEdges" : null) +
        "></rect>");

      if (browser.divider === "line") {
        if (browserIdx > 0) {
          out.w("<line x1=\"0.5\" x2=\"0.5\" y1=\"0\" y2=\"20\" stroke-width=\"1\" stroke=\"#fff\" stroke-opacity=\"0.3\"></line>");
        }

        if (browserIdx === (browsers.length - 1)) {
          out.w("<line" +
            marko_attr("x1", "" + (browser.width - 0.5)) +
            marko_attr("x2", "" + (browser.width - 0.5)) +
            " y1=\"0\" y2=\"20\" stroke-width=\"1\" stroke=\"#010101\" stroke-opacity=\"0.1\"></line>");
        }
      }
      ...
      if (data.layout.style !== "flat-square") {
        out.w("<text" +
          marko_attr("x", "" + browser.x) +
          " y=\"15\" fill=\"#010101\" fill-opacity=\"0.3\">" +
          marko_escapeXml(browser.text) +
          "</text>");
      }
...
marko_template.meta = {
    id: "/badges$7.5.1/src/browsers.svg"
  };
